...
public class Knight {
    ...
    public static int findShortestDistance(Knight src, Knight dest, int N)
    {
    ...
    public static void main(String[] args)
    {
        ...
        // source coordinates
        Knight src = new Knight(0, 7);

        // destination coordinates
        Knight dest = new Knight(7, 0);
